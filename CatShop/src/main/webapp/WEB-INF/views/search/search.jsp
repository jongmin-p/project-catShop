			...
			<c:forEach var="list" items="${list }">
				<div class="col mb-5 colbox">
					<div class="card h-100">
						<!-- Product image-->
						<a href="productDetail.do?pid=${list.proId }"><img
							class="card-img-top" src="images/${list.proImg }" alt="..."
							class="img" /></a>
						<!-- Product details-->
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a data-id="${list.proId}" data-price="${list.proPrice }"
									class="btn btn-outline-dark mt-auto">Add to cart</a>
							</div>
						</div>
					</div>
				</div>
