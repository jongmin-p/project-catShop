...
public class ReviewManageList implements Command {
	...
	public String exec(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//총 상품 개수 조회
		int count = countService.getManageReviewList().size();
        ...
        List<ProductVO> reviewList = service.getManageReviewListPage(paging);
		...
		result.add("reviewList", gson.toJsonTree(reviewList));
